...
class Pipe:
    class Valves(BaseModel):
        ...
        GIT_TEMPLATE_REPOS: List[str] = Field(
            default=[],
            description="List of Git repositories containing additional templates"
        )
        ...
        try:
            ...
            async with httpx.AsyncClient(limits=limits, timeout=timeout) as client:
                ...
                if action == "write_full_doc":
                    ...
                    async for chunk in self.handle_create_outline(client, params, headers, __event_emitter__):
                        yield chunk
                else:
...
Where should this new section be placed in the document structure? Return the position as a JSON object."""
    ...
    async def handle_create_outline(self, client, params, headers, __event_emitter__=None):
    ...
    def load_git_templates(self):
        ...
        for repo_url in self.valves.GIT_TEMPLATE_REPOS:
            try:
